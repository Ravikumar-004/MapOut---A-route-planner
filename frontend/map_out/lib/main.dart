...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              SizedBox(height: 10),
              TextField(controller: avoidCtrl, decoration: InputDecoration(labelText: "Avoid (optional)")),
              SizedBox(height: 20),
              ElevatedButton.icon(
                  onPressed: _getRoute, icon: Icon(Icons.directions), label: Text("Get Route")),
            ]),
          ),
        ),
  ...
  Future<void> _getRoute() async {
    final apiBase = dotenv.env['BACKEND_URL'] ?? "http://10.0.2.2:8000";
    final body = {
      "start_lat": 20.2670,
      "start_lon": 85.8436,
      "end_lat": 20.3550,
